        ...
        <div>
            ...
            <div className='flex flex-col w-full px-6 bg-white shadow-1 py-7'>
                ...
                <Input
                    ...
                    control={control}
                    name='Pledge'
                    className='w-full px-5 py-2 mb-5 text-lg font-medium border rounded border-strockSoft'></Input>
                <div className='p-5 mb-5 bg-grayf3 rounded-xl'>
                    <p className='text-sm font-semibold text-text2'>
                        Back it because you believe in it.
                    </p>
                    <p className='text-sm text-text3'>Support the project for no reward, just because
                        it speaks to you.</p>
                </div>
