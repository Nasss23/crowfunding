...
const DashboardSearch = () => {
    ...
    return (
        <div className='relative z-50'>
            ...
            {showSearch && <div className='search-results lg:w-[843px] w-full bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl'>
                ...
                <div className="p-6">
                    ...
                    <div className="flex flex-col text-sm gap-y-3 text-text2">
                        ...
                        <p><strong>education</strong> and schools fund</p>
                    </div>
                </div>
            </div>}
        </div>
